              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: const Text('Dikirim dari Desa Gumelem Kulon'),
                    trailing: const Text(
                      'berat: 2kg',
                ...
                const SpaceHeight(12.0),
                const Text(
                  'Estimasi tiba 29 - 30 Mei (Rp. 20.000)',
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
                  ),
      ...
      child: Container(
        ...
        child: const Column(
          ...
          children: [
            ...
            Text('Estimasi tiba 3 Juni 2024'),
          ],
        ),
      ),
    );
